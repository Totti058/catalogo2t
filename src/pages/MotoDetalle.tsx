            ...
            <div className="animate-fade-up-delay-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="btn-gold px-6 py-4 text-sm tracking-widest uppercase font-display text-lg text-center flex-1 rounded-md flex items-center justify-center gap-2"
                >
                ...
                <Link
                  to="/contact"
                  className="border border-gold-700/60 text-gold-400 px-6 py-4 text-sm tracking-widest uppercase font-display text-lg hover:bg-gold-500/8 hover:border-gold-500 transition-all duration-300 text-center flex-1 rounded-md"
                >
                  Más información
                </Link>
              </div>
