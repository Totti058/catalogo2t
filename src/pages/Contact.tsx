    ...
    <main className="min-h-screen pt-20 bg-[#0a0a0a]">
      ...
      <section className="relative py-20 px-6 bg-black border-b border-[#1a1a1a] overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gold-500/3 rounded-full blur-3xl" />
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8 animate-fade-up">
            ...
            {/* Phone — PROMINENTE */}
            <div className="bg-[#111] border border-gold-700/40 p-6 relative overflow-hidden group hover:border-gold-500/60 transition-colors duration-300">
              ...
              <a
                href="tel:3007442878"
                className="font-display text-4xl text-gold-500 tracking-widest hover:text-gold-300 transition-colors block"
              >
                300 744 2878
              </a>
            ...
            <a
              ...
              className="btn-gold px-6 py-4 text-sm tracking-widest uppercase font-display text-base flex items-center justify-center gap-3 w-full"
            >
            ...
            <div className="space-y-4 pt-4 border-t border-[#1a1a1a]">
              {[
                ...
                <div key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-gray-600 text-[10px] tracking-[0.3em] uppercase font-body">
                      {label}
                    </p>
          ...
          <div className="lg:col-span-3 animate-fade-up-delay-1">
            <div className="bg-[#111] border border-[#1e1e1e] p-8 relative">
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold-600/40 to-transparent" />

              {enviado ? (
                <div className="py-16 text-center">
                  <div className="w-16 h-16 border-2 border-gold-500 mx-auto mb-6 flex items-center justify-center">
                    <span className="text-gold-500 text-2xl">✓</span>
                  </div>
                  <h3 className="font-display text-3xl text-white tracking-widest mb-2">
                    ¡MENSAJE ENVIADO!
                  </h3>
                  ...
                  <button
                    ...
                    className="btn-gold px-8 py-3 text-sm tracking-widest uppercase font-display text-base"
                  >
                    Enviar otro mensaje
                  </button>
                </div>
                ...
                <>
                  <h2 className="font-display text-2xl text-white tracking-widest mb-1">
                    ENVIAR <span className="text-gold-500">MENSAJE</span>
                  </h2>
                  <div className="gold-line mb-6" style={{ width: '30px', height: '2px' }} />

                  <form onSubmit={handleSubmit} className="space-y-5">
                    {/* Nombre */}
                    <div>
                      <label className="block text-gray-500 text-[10px] tracking-[0.3em] uppercase font-body mb-2">
                        Nombre completo *
                      </label>
                      <input
                        type="text"
                        ...
                        className="input-dark w-full px-4 py-3 font-body text-sm"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="input-dark w-full px-4 py-3 font-body text-sm resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="btn-gold w-full py-4 text-sm tracking-widest uppercase font-display text-base disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <>
                    ...
                    <p className="text-gray-700 text-xs font-body text-center">
                      ...
                      <a href="tel:3007442878" className="text-gold-600 hover:text-gold-400 transition-colors">
                        300 744 2878
                      </a>
                    </p>
                  </form>
      ...
      {/* Bottom banner */}
      <section className="py-10 px-6 bg-black border-t border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-600 font-body text-xs mt-1 tracking-wider">
              Llámanos · WhatsApp · SMS
            </p>
          </div>
          <a
            href="https://wa.me/573007442878"
