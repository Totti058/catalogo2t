    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Corner decorations */}
          <div className="absolute top-24 right-8 md:right-16 w-24 h-24 border border-gold-700/25 rotate-45" />
          <div className="absolute top-28 right-12 md:right-20 w-16 h-16 border border-gold-600/12 rotate-45" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center pt-20">
          ...
          <div className="animate-fade-up-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/motos"
              className="btn-gold px-10 py-4 text-sm tracking-widest uppercase font-display text-xl min-w-[200px] text-center rounded-md flex items-center justify-center gap-2"
            >
              Ver Catálogo
            ...
            <Link
              to="/contact"
              className="border border-gold-700/60 text-gold-400 px-10 py-4 text-sm tracking-widest uppercase font-display text-xl hover:bg-gold-500/8 hover:border-gold-500 transition-all duration-300 min-w-[200px] text-center rounded-md"
            >
              Contáctanos
            </Link>
          </div>
      ...
      <section className="py-24 px-6 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 text-center">
            ...
            <Link
              to="/motos"
              className="btn-gold px-10 py-3.5 text-sm tracking-widest uppercase font-display text-lg inline-flex items-center gap-2 rounded-md"
            >
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="btn-gold px-8 py-4 text-base tracking-widest uppercase font-display text-xl rounded-md flex items-center gap-2"
            >
            ...
            <Link
              to="/contact"
              className="border border-gold-700/60 text-gold-400 px-8 py-4 text-base tracking-widest uppercase font-display text-xl hover:bg-gold-500/8 hover:border-gold-500 transition-all duration-300 rounded-md"
            >
              Enviar mensaje
            </Link>
          </div>
