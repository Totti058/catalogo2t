    ...
    <main className="min-h-screen pt-20 bg-[#0a0a0a]">
          ...
          {filtered.length > 0 ? (
            ...
            <div className="py-28 text-center">
              ...
              <button
                ...
                className="btn-gold px-7 py-2.5 text-sm tracking-widest uppercase font-display text-base rounded-md"
              >
                Limpiar filtros
              </button>
            </div>
      ...
      <section className="py-16 px-6 bg-[#0d0d0d] border-t border-[#1a1a1a] text-center">
        ...
        <a
          ...
          className="btn-gold px-8 py-3.5 text-sm tracking-widest uppercase font-display text-lg inline-flex items-center gap-2 rounded-md"
        >
